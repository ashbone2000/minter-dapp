const contractAddress = "0x840Ac2a521F61DB1fd3d05BbC3B83ad86fF90E67"; // Replace with your own contract address
const chain = 'goerli'; // goerli, polygon, or ethereum

const welcome_h1 = "Welcome to the Rabbitat Genesis NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'These tokens are the genesis mint for the Rabbitat.  A Playboy Rabbitar DeRabbitive collection of the official Playboy collection found at https://opensea.io/collection/playboyrabbitars and the license granted by owning Rabbitar #1987. More info https://rabbitat.io';
